module PagesComponents.Home_.Views.Helpers.SvgIcon exposing (documentSearch, github, inbox, link, photograph, twitter)
...
twitter : Html msg
twitter =
    svg [ class "h-6 w-6", fill "currentColor", viewBox "0 0 24 24", ariaHidden True ]
