...
suite =
    describe "StatementParser"
        [ describe "parseCommand"
            [ stmCheck "parse create table" "CREATE TABLE aaa.bbb (ccc int);" parseCommand (\s -> Ok (CreateTable { schema = Just "aaa", table = "bbb", columns = Nel { name = "ccc", kind = "int", nullable = True, default = Nothing, primaryKey = Nothing, foreignKey = Nothing } [], source = s }))
