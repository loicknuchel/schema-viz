module Updates.Canvas exposing (computeFit, fitCanvas, handleWheel, performZoom, zoomCanvas)
...
import Models.Schema exposing (CanvasProps, Layout, tablesArea, viewportArea, viewportSize)
import Models.Utils exposing (ZoomLevel)
import Updates.Helpers exposing (setCanvas, setTables)
