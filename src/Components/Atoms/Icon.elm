...
github : Html msg
github =
    svg [ css [ Tw.h_6, Tw.w_6 ], fill "currentColor", viewBox "0 0 24 24", attribute "aria-hidden" "true" ]
...
icon draw =
    svg [ css [ Tw.h_6, Tw.w_6 ], fill "none", viewBox "0 0 24 24", stroke "currentColor", attribute "aria-hidden" "true" ]
